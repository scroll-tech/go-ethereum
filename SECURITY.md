...
To find out how to disclose a vulnerability in Ethereum visit [https://ethereum.org/en/bug-bounty/](https://ethereum.org/en/bug-bounty/) or email bounty@ethereum.org. Please read the [disclosure page](https://github.com/scroll-tech/go-ethereum/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.
