...
func newZkTrieProofWriter(storage *types.StorageRes) (*zktrieProofWriter, error) {
...
func (w *zktrieProofWriter) traceAccountUpdate(addr *common.Address, getAccData func(*types.StateAccount) *types.StateAccount) (*types.StateTrace, error) {
...
func (w *zktrieProofWriter) buildSStore(l *types.StructLogRes) (*types.StateTrace, error) {
...
func (w *zktrieProofWriter) buildCreate(l *types.StructLogRes) (*types.StateTrace, error) {
	w.tracingAccounts[getAccountProof(l, posCREATE).Address.String()] = nil
	return w.buildCreateOrCall(l, posCREATE, posCREATE)
}

func (w *zktrieProofWriter) buildCreateOrCall(l *types.StructLogRes, posBefore, posAfter int) (*types.StateTrace, error) {
	...
	out.CommonStateRoot = zkt.ReverseByteOrder(accData.Root[:])

	return out, nil
}

// Fill smtproof field for execResult
func (w *zktrieProofWriter) handleLogs(logs []types.StructLogRes) error {
...
func (w *zktrieProofWriter) handleAccountCreate(buf []byte) error {
	if buf == nil {
		return nil
	}
...
func (w *zktrieProofWriter) handleCallEnd(calledLog *types.StructLogRes) error {
...
//finally update account status which is not traced in logs (Nonce added, gasBuy, gasRefund etc)
func (w *zktrieProofWriter) handlePostTx(accs map[string]hexutil.Bytes) error {
...
func (w *zktrieProofWriter) txFinal(rootAfter *common.Hash) error {

	root := w.tracingZktrie.Hash()
