...
func TestWriterCreation(t *testing.T) {
	trace := loadStaff(t, "blocktraces/deploy.json")
...
func TestGreeterTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/greeter.json")
	writer, err := zkproof.NewZkTrieProofWriter(trace.StorageTrace)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTokenTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/token.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestCallTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/call.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
	...
	trace = loadStaff(t, "blocktraces/call_edge.json")
	traces, err = zkproof.HandleBlockResult(trace)
	outObj, _ = json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestCreateTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/create.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestFailedCallTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/fail_call.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
	...
	trace = loadStaff(t, "blocktraces/fail_create.json")
	traces, err = zkproof.HandleBlockResult(trace)
	outObj, _ = json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestDeleteTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/delete.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestDestructTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/destruct.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
...
func TestMutipleTx(t *testing.T) {
	trace := loadStaff(t, "blocktraces/multi_txs.json")
	traces, err := zkproof.HandleBlockResult(trace)
	outObj, _ := json.Marshal(traces)
	t.Log(string(outObj))
	if err != nil {
