...
func (w *worker) commitTransaction(tx *types.Transaction, coinbase common.Address) ([]*types.Log, error) {
	...
	// has to do check circuit capacity before core.ApplyTransaction,
	// otherwise if the tx can be excuted but circuit capacity exceeds, it will be hard to revert
