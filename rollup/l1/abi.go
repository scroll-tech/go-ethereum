...
var (
	...
	// ScrollChainValidiumABI holds information about ScrollChainValidium's NewEncryptionKey event.
	ScrollChainValidiumABI *abi.ABI
)

func init() {
	ScrollChainABI, _ = ScrollChainMetaData.GetAbi()
	L1MessageQueueABIManual, _ = L1MessageQueueMetaDataManual.GetAbi()
	ScrollChainValidiumABI, _ = ScrollChainValidiumMetaData.GetAbi()
}
...
// ScrollChainValidiumMetaData contains ABI of the ScrollChainValidium contract (NewEncryptionKey event).
var ScrollChainValidiumMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"event\",\"name\":\"NewEncryptionKey\",\"inputs\":[{\"name\":\"keyId\",\"type\":\"uint256\",\"indexed\":true,\"internalType\":\"uint256\"},{\"name\":\"msgIndex\",\"type\":\"uint256\",\"indexed\":false,\"internalType\":\"uint256\"},{\"name\":\"key\",\"type\":\"bytes\",\"indexed\":false,\"internalType\":\"bytes\"}],\"anonymous\":false}]",
}
