...
func TestMerkleTree_UpdateAccount(t *testing.T) {
	...
	acc1 := &types.StateAccount{
		...
		CodeHash: common.HexToHash("0c0a77f6e063b4b62eb7d9ed6f427cf687d8d0071d751850cfe5d136bc60d3ab").Bytes(),
	}
	...
	acc2 := &types.StateAccount{
		...
		CodeHash: common.HexToHash("05d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470").Bytes(),
	}
